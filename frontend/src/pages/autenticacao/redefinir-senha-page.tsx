...
export function RedefinirSenhaPage() {
  ...
  if (!token) {
    ...
    return (
      <LayoutAutenticacao>
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-teal">Link invalido</p>
        <h2 className="mt-4 font-display text-4xl font-semibold text-slateblue">Solicite um novo link</h2>
        ...
        <Link className="mt-8 inline-flex rounded-md bg-slateblue px-5 py-3 font-semibold text-white" to="/recuperar-senha">
          Solicitar novo link
        </Link>
      </LayoutAutenticacao>
    );
  ...
  return (
    <LayoutAutenticacao>
      ...
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-teal">Nova senha</p>
